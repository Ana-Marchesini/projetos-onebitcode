// array para armazenar vagas salvar - ESCOPO MAIS EXTERNO
const vacancy = [];

// função que vai listar vagas
...
// função que vai adicionar uma nova vaga
function novaVaga() {
...
// função que vai exibir  uma vaga
function exibirVaga() {
...
// função de escrever um candidato em uma vaga
...
// função que vai excluir uma vaga
